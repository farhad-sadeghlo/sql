...
--QUERY 7
SELECT v.vendor_id, v.vendor_name, v.vendor_type, v.vendor_owner_first_name, v.vendor_owner_last_name, vb.market_date, vb.booth_number
FROM vendor AS v
...
SELECT c.customer_id, c.customer_first_name, c.customer_last_name
 ...
 GROUP BY c.customer_id, customer_last_name, customer_first_name
...
INSERT INTO temp (vendor_id, vendor_name, vendor_type, vendor_owner_first_name, vendor_owner_last_name)
...
Limit to 25 rows of output. */
--QUERY 11
SELECT customer_id, STRFTIME('%m', transaction_time) AS month, STRFTIME('%Y', transaction_time) AS year
FROM customer_purchases
LIMIT 25;
